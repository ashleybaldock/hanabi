...
var firework = require('../lib/Firework.js');
...
suite('Firework', function() {
    ...
    suite('contract', function() {
        ...
        test('should define addFireworkCompleteObserver() method', function() {
            expect(sut.addFireworkCompleteObserver).not.to.be(undefined);
        ...
        test('should define addInvalidPlayObserver() method', function() {
            expect(sut.addInvalidPlayObserver).not.to.be(undefined);
