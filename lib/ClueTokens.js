...
exports.ClueTokens.prototype.objectName = 'ClueTokens';

exports.ClueTokens.prototype.cluesRemaining = function () {
    return this.clues;
};
...
exports.ClueTokens.prototype.restoreClue = function () {
    if (this.clues === this.max) return;
    this.clues += 1;
