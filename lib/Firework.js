...
exports.Firework.prototype.fireworkCompleteObservers = [];
exports.Firework.prototype.invalidPlayObservers = [];
...
exports.Firework.prototype.play = function(value) {
    if (typeof value !== 'number') throw 'InvalidArgument';
    if (value < 1 || value > this.max) throw "InvalidArgument";
...
exports.Firework.prototype.addFireworkCompleteObserver = function(callback, context) {
    if (typeof callback !== 'function') throw 'InvalidArgument';
    if (typeof context !== 'object') throw 'InvalidArgument';
