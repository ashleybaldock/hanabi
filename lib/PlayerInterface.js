...
// data: null
exports.PlayerInterface.prototype.readyObserver = function (data) {
};
// data: null
...
exports.PlayerInterface.prototype.playObserver = function (data) {
    console.log('playing: ' + JSON.stringify(data.card));
};
...
exports.PlayerInterface.prototype.gameOverObserver = function (data) {
};
