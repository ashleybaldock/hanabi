...
exports.Game = function Game (name, playerCount,
        discardConstructor, cluetokensConstructor) {
    ...
    for (var i = 0; i < playerCount; i++) {
        ...
        // Should wire discardCard and restoreClue events from the created hand
        // up to the Discard and ClueToken objects
    }
};
...
exports.Game.prototype.onDeckExhausted = function () {
};
