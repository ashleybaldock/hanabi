...
exports.Game.prototype.sendCardDrawnToAllPlayers = function (playerIndex, cardIndex, card) {
    for (var i = 0; i < this.playerCount; i++) {
        ...
        if (encodedPlayerIndex === 0) {
            ...
            this.players[i].cardDrawnObserver({playerIndex: encodedPlayerIndex, cardIndex: cardIndex, card: new Card(null, null)});
        } else {
            this.players[i].cardDrawnObserver({playerIndex: encodedPlayerIndex, cardIndex: cardIndex, card: card});
        }
    }
};
...
exports.Game.prototype.sendCardPlayedToAllPlayers = function (playerIndex, cardIndex, card) {
    for (var i = 0; i < this.playerCount; i++) {
        var encodedPlayerIndex = this.encodeIndex(i, playerIndex);
        this.players[i].playObserver({playerIndex: encodedPlayerIndex, cardIndex: cardIndex, card: card});
    }
};
