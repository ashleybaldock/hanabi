...
exports.Game.prototype.addPlayer = function (player, callback) {
    ...
    var setPlayer = function (index, player) {
        ...
        // TODO - register ALL hands to send this event to player
        //        (but most will be visible/straightforward)
        ...
        // TODO register ALL hands to send this event to player
        //hand.registerForEvent('clueReceived', function (toIndex, fromIndex, clueMask) {
            // Map toIndex and fromIndex into this hand's index system
        //}, this);

        //this.discard.registerForEvent('cardDiscarded', player.discardObserver, player);
