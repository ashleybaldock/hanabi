...
exports.Game = function Game (name, playerCount,
    ...
    this.turncounter = new turncounterConstructor(playerCount);
    this.deck = new Deck();
    this.lifetokens = new LifeTokens(3);
    this.cluetokens = new cluetokensConstructor(9);
    ...
    for (var i = 0; i < playerCount; i++) {
        ...
        hand.registerForEvent('giveClue', this.giveClueHandler, this);
...
exports.Game.prototype.giveClueHandler = function (fromIndex, clientToIndex, clue, callback) {
    console.log('exports.Game.prototype.giveClueHandler - fromIndex: ' + fromIndex + ', clientToIndex: ' + clientToIndex + ', clue: ' + clue);
...
exports.Game.prototype.sendClueReceivedToAllPlayers = function (fromIndex, toIndex, clueMask) {
    for (var i = 0; i < this.playerCount; i++) {
...
exports.Game.prototype.sendGameOverToAllPlayers = function (win, score) {
    for (var i = 0; i < this.playerCount; i++) {
        this.players()[i].gameOverObserver({score: score, win: win});
    }
};

exports.Game.prototype.onAllFireworksComplete = function (score) {
    // TODO Game over - send event to all players to inform them of the game results
    console.log('Game.onAllFireworksComplete - score: ' + score);
    this.sendGameOverToAllPlayers(true, score);
};
exports.Game.prototype.onAllLivesLost = function () {
    // TODO Game over - send event to all players to inform them of the game results
    console.log('Game.onAllLivesLost - score: ' + 0);
    this.sendGameOverToAllPlayers(false, 0);
};
exports.Game.prototype.onEndgameOver = function () {
    // TODO Game over - send event to all players to inform them of the game results
    console.log('Game.onEndgameOver - score: ' + this.fireworks.getScore());
    this.sendGameOverToAllPlayers(true, this.fireworks.getScore());
};
