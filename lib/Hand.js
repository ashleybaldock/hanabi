...
exports.Hand = function Hand (index, cardCount, deck, fireworks) {
...
exports.Hand.prototype.events = ['cardDrawn', 'discardCard', 'restoreClue', 'turnComplete', 'giveClue'];
...
exports.Hand.prototype.receiveClue = function (toIndex, fromIndex, clue, callback) {
    // Check clue is valid
    // Should match either the colour or number of one of our cards
    // If invalid callback with error
    // If valid, call useClue on ClueTokens
    // If no clues remain, execute our own callback with error
    // Else emit clueReceived event with indexes and clue
    // And execute callback with success
};
