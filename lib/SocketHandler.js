...
exports.SocketHandler.prototype.playCard = function (data, callback) {
    this.sendEvent('playCard', [data.cardIndex, callback]);
};
exports.SocketHandler.prototype.discardCard = function (data, callback) {
    this.sendEvent('discardCard', [data.cardIndex, callback]);
};
exports.SocketHandler.prototype.giveClue = function (data, callback) {
    console.log('exports.SocketHandler.prototype.giveClue - data: ' + JSON.stringify(data));
    this.sendEvent('giveClue', [data.toPlayerIndex, data.clue, callback]);
};
...
// data: {playerIndex: Number, cardIndex: Number, card: Card, result: 'ok'|'failed'}
...
// data: {score: Number, win: Boolean}
exports.SocketHandler.prototype.gameOverObserver = function (data) {
